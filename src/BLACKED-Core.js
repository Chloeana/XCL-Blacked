...
// Macro for checking character side effects
Harlowe.macro('is_QoS', function() {
  var character = Harlowe.variable('$character');
  var sideEffects = character.get('side effects');
  return sideEffects.includes("QoS");
});

Harlowe.macro('is_bbc_addict', function() {
  var character = Harlowe.variable('$character');
  var sideEffects = character.get('side effects');
  return sideEffects.includes("bbc addiction") || sideEffects.includes("bbc addiction temp");
});

Harlowe.macro('is_bbc_sizequeen', function() {
  var character = Harlowe.variable('$character');
  var sideEffects = character.get('side effects');
  return sideEffects.includes("bbc sizequeen") || sideEffects.includes("bbc sizequeen temp");
});